var authorization = "PASTE YOUR AUTH CODE HERE"; // replace with authorization value
var ua = navigator.userAgentData.brands.map(brand => `"${brand.brand}";v="${brand.version}"`).join(', ');
var client_tid = "PASTE YOUR X-CLIENT TRANS ID HERE"; // replace with X-Client-Transaction-Id value
var client_uuid = "PASTE YOUR X-CLIENT-UUID HERE"; // replace with X-Client-Uuid value
...
var username = "YOURTWITTERHANDLEHERE" // replace with your username
...
var delete_options = {
	...
	*/
	...
	"before_date":new Date('2024-06-21') // year-month-day
}
